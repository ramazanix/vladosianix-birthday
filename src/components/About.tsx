...
const About = () => {
  ...
  const thirdText =
    "Ты, блядь, жил, любил, страдал… Сначала Лерка, теперь Маша. Но, братан, ты пережил этот пиздец, и это главное. Да, Маша уже с пузом от какого-то кринжового додика, да, Лерка тоже оказалась хуйнёй. Но знаешь что? Ты – свободный мужчина! И теперь перед тобой открыты миллионы ниггерских членов… или, ну, что ты там выберешь.";
  const fourthText =
